...
<template>
  <div class="flex justify-content-center w-full">
    ...
    >
      <SplitterPanel class="hidden md:flex flex-column align-items-start overflow-y-scroll" :size="20" :min-size="15">
        <PendingReviewsList class="" />
      </SplitterPanel>
      <SplitterPanel class="flex justify-content-center p-3 h-full overflow-y-auto" :size="80" :min-size="50">
