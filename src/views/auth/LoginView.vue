      ...
      <template #content>
        <form @submit.prevent="onSubmit" class="flex flex-column align-items-center gap-3">
          ...
          <InputGroup>
            ...
            <InputText v-tooltip.right="v$.login.$errors[0]?.$message || ''" v-model="login"
                       :class="{ 'p-invalid': v$.login.$errors[0] }" placeholder="Login"/>
          </InputGroup>
          ...
          <InputGroup>
            ...
            <Password :feedback="false" toggleMask v-tooltip.right="v$.password.$errors[0]?.$message || ''" v-model="password"
          ...
          <div class="flex flex-column">
            <small>
              Don't have an account yet? <RouterLink to="/register" class="link-primary">Register</RouterLink>
            </small>
            <small>
              Forgot your password? <RouterLink to="/register" class="link-primary">Reset password</RouterLink>
            </small>
          </div>
        </form>
